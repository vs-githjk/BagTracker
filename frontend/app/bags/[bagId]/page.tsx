  ...
  return (
    <div className="p-6 space-y-6 max-w-5xl">
      ...
      <div className="flex items-start justify-between gap-4">
        ...
        <div className="flex items-center gap-3">
          ...
          <button
            ...
            className="flex items-center gap-1.5 px-4 py-2 text-sm bg-orange-600 hover:bg-orange-500 text-white rounded-lg font-medium transition-colors disabled:opacity-50 disabled:cursor-not-allowed dark:bg-orange-700 dark:hover:bg-orange-600"
          >
      ...
      <div className="grid grid-cols-2 gap-4">
          ...
          <div className="space-y-2">
            {(bag.risk_reasons || []).map((r, i) => (
              <div key={i} className="flex items-start gap-2 text-sm text-slate-600 dark:text-slate-300">
                <AlertTriangle className="w-3.5 h-3.5 text-orange-500 dark:text-orange-400 mt-0.5 shrink-0" />
                {r}
              </div>
            ))}
          </div>
        ...
        <div className="bg-white border border-slate-200 rounded-xl p-5 dark:bg-slate-900 dark:border-slate-800">
          <h2 className="text-xs font-semibold text-slate-400 dark:text-slate-500 uppercase tracking-wide mb-4">Recommended Action</h2>
          <div className="p-3 bg-blue-50 border border-blue-200 rounded-lg text-blue-800 text-sm leading-relaxed mb-4 dark:bg-blue-950 dark:border-blue-800 dark:text-blue-200">
            {bag.recommended_action}
          </div>
          <h3 className="text-xs font-semibold text-slate-400 dark:text-slate-500 uppercase tracking-wide mb-2">Key Flags</h3>
